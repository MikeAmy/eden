...
Ext.onReady(function(){map=new OpenLayers.Map("center",S3.gis.options);addLayers();addControls();S3.gis.mapPanel=new GeoExt.MapPanel({region:"center",id:"mappanel",xtype:"gx_mappanel",map:map,center:S3.gis.center,zoom:S3.gis.zoom,plugins:[]});S3.gis.portal={};S3.gis.portal.map=S3.gis.mapPanel;S3.gis.mapPanelContainer=new Ext.Panel({layout:"card",id:"mappnlcntr",defaults:{border:!1},items:[S3.gis.mapPanel],activeItem:0,tbar:new Ext.Toolbar,scope:this});S3.gis.Google&&S3.gis.Google.Earth&&(S3.gis.googleEarthPanel=
new gxp.GoogleEarthPanel({mapPanel:S3.gis.mapPanel}),S3.gis.mapPanelContainer.items.items.push(S3.gis.googleEarthPanel));addLayerTree();S3.gis.toolbar&&addToolbar();S3.gis.wms_browser_url&&addWMSBrowser();if(S3.i18n.gis_legend){for(a=0;a<map.layers.length;a++)map.layers[a].legendURL&&(S3.gis.mapPanel.layers.data.items[a].data.legendURL=map.layers[a].legendURL);S3.gis.legendPanel=new GeoExt.LegendPanel({id:"legendpanel",title:S3.i18n.gis_legend,defaults:{labelCls:"mylabel",style:"padding:5px"},bodyStyle:"padding:5px",
autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1})}S3.i18n.gis_search&&(a=new GeoExt.ux.GeoNamesSearchCombo({map:map,zoom:12}),S3.gis.searchCombo=new Ext.Panel({id:"searchCombo",title:S3.i18n.gis_search,layout:"border",rootVisible:!1,split:!0,autoScroll:!0,collapsible:!0,collapseMode:"mini",lines:!1,html:S3.i18n.gis_search_no_internet,items:[{region:"center",items:[a]}]}));for(var a=0;a<S3.gis.plugins.length;++a)S3.gis.plugins[a].setup(map);void 0==S3.gis.west_collapsed&&(S3.gis.west_collapsed=
!1);var b=[S3.gis.layerTree];S3.gis.wmsBrowser&&b.push(S3.gis.wmsBrowser);S3.gis.searchCombo&&b.push(S3.gis.searchCombo);S3.gis.printFormPanel&&b.push(S3.gis.printFormPanel);S3.gis.legendPanel&&b.push(S3.gis.legendPanel);for(a=0;a<S3.gis.plugins.length;++a)S3.gis.plugins[a].addToMapWindow(b);S3.gis.mapWin=new Ext.Panel({id:"gis-map-panel",renderTo:"map_panel",height:600,maximizable:!0,titleCollapse:!0,monitorResize:!0,layout:"anchor",items:new Ext.Panel({anchor:"100%, 100%",layout:"border",items:[{region:"west",
id:"tools",header:!1,border:!1,width:400,autoScroll:!0,collapsible:!0,collapseMode:"mini",collapsed:S3.gis.west_collapsed,split:!0,items:b},{region:"center",margins:"0 0 0 0",cmargins:"0 0 0 0",layout:"fit",items:[S3.gis.mapPanelContainer]}]})});S3.gis.bounds&&map.zoomToExtent(S3.gis.bounds);if(S3.gis.layers_wms)for(a=0;a<map.layers.length;a++)map.layers[a].queryable&&(S3.gis.mapPanel.layers.data.items[a].data.queryable=1);Ext.QuickTips.init()});
...
leaf:!1,expanded:!0}],b=S3.gis.dirs;for(i=0;i<b.length;i++){var c={text:b[i],nodeType:"gx_layercontainer",layerStore:S3.gis.mapPanel.layers,loader:{filter:function(a){return function(b){if("undefined"!==b.data.layer.dir)return b.data.layer.dir===a}}(b[i])},leaf:!1,expanded:!0};a.push(c)}a=new Ext.tree.AsyncTreeNode({expanded:!0,children:a});b=S3.i18n.gis_uploadlayer?new Ext.Toolbar:null;S3.gis.layerTree=new Ext.tree.TreePanel({id:"treepanel",title:S3.i18n.gis_layers,loader:new Ext.tree.TreeLoader({applyLoader:!1}),
...
!1,f=!0,g=!1;else"active"==S3.gis.draw_polygon?(f=e=!1,g=!0):(e=!0,g=f=!1);S3.gis.panButton=new GeoExt.Action({control:new OpenLayers.Control.Navigation,map:map,iconCls:"pan-off",tooltip:S3.i18n.gis_pan,toggleGroup:"controls",allowDepress:!0,pressed:e});a.add(b);navigator.geolocation&&addGeolocateControl(a);void 0===S3.gis.loc_select&&(a.add(c),a.add(d),a.add(S3.gis.panButton),a.addSeparator());void 0===S3.gis.loc_select&&addNavigationControl(a);void 0===S3.gis.loc_select&&S3.gis.region&&addSaveButton(a);
a.addSeparator();addMeasureControls(a);S3.gis.mgrs_url&&addPdfControl(a);if(S3.gis.draw_feature||S3.gis.draw_polygon)a.addSeparator(),S3.gis.draw_feature&&addPointControl(a,f),S3.gis.draw_polygon&&addPolygonControl(a,g);S3.i18n.gis_get_feature_info&&addWMSGetFeatureInfoControl(a);S3.gis.osm_oauth&&addPotlatchButton(a);S3.gis.Google&&S3.gis.Google.StreetviewButton&&addGoogleStreetviewControl(a);try{S3.gis.Google.Earth&&google&addGoogleEarthControl(a)}catch(h){}for(b=0;b<S3.gis.plugins.length;++b)S3.gis.plugins[b].setupToolbar(a)}
S3.gis.layers_all=[];S3.gis.format_geojson=new OpenLayers.Format.GeoJSON;S3.gis.dirs=[];
...
function addGeoJSONLayer(a){var b=a.name,c=a.url;if(void 0!=a.marker_image)var d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width;else d="";var g=void 0!=a.refresh?a.refresh:900;if(void 0!=a.dir){var h=a.dir;-1==$.inArray(h,S3.gis.dirs)&&S3.gis.dirs.push(h)}else h="";var j=void 0!=a.visibility?a.visibility:!0,l=void 0!=a.opacity?a.opacity:1,n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,m=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold,
...
"":a.attributes.marker_url?a.attributes.marker_url:d},radius:function(a){return a.cluster?Math.min(a.attributes.count/2,8)+10:a.attributes.size?a.attributes.size:10},fill:function(a){return a.cluster?"#8087ff":a.attributes.colour?a.attributes.colour:"#f5902e"},stroke:function(a){return a.cluster?"#2b2f76":a.attributes.colour?a.attributes.colour:"#f5902e"},label:function(a){var b="";a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}}),l=new OpenLayers.StyleMap({"default":l,select:{fillColor:"#ffdc33",
strokeColor:"#ff9933"}}),b=new OpenLayers.Layer.Vector(b,{dir:h,projection:a,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Refresh({force:!0,interval:1E3*g}),new OpenLayers.Strategy.Cluster({distance:n,threshold:m})],legendURL:d,styleMap:l,protocol:new OpenLayers.Protocol.HTTP({url:c,format:S3.gis.format_geojson})});b.setVisibility(j);b.events.on({featureselected:onGeojsonFeatureSelect,featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
...
function addGPXLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=a.marker_height,f=a.marker_width,g=void 0!=a.waypoints?a.waypoints:!0,h=void 0!=a.tracks?a.tracks:!0,j=void 0!=a.routes?a.routes:!0,l=void 0!=a.visibility?a.visibility:!0;if(void 0!=a.dir){var n=a.dir;-1==$.inArray(n,S3.gis.dirs)&&S3.gis.dirs.push(n)}else n="";var m=void 0!=a.opacity?a.opacity:1,p=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,a=void 0!=a.cluster_threshold?a.cluster_threshold:
S3.gis.cluster_threshold,k=OpenLayers.Util.extend({},OpenLayers.Feature.Vector.style["default"]);g?(k.graphicOpacity=m,k.graphicWidth=f,k.graphicHeight=e,k.graphicXOffset=-(f/2),k.graphicYOffset=-e,k.externalGraphic=d):k.externalGraphic="";k.strokeColor="blue";k.strokeWidth=6;k.strokeOpacity=m;b=new OpenLayers.Layer.Vector(b,{dir:n,projection:S3.gis.proj4326,strategies:[new OpenLayers.Strategy.Fixed,new OpenLayers.Strategy.Cluster({distance:p,threshold:a})],legendURL:d,style:k,protocol:new OpenLayers.Protocol.HTTP({url:c,
...
function addKMLLayer(a){var b=a.name,c=a.url,d=S3.gis.marker_url+a.marker_image,e=void 0!=a.title?a.title:"name",f=void 0!=a.body?a.body:"description",g=void 0!=a.refresh?a.refresh:900,h=void 0!=a.visibility?a.visibility:!0;if(void 0!=a.dir){var j=a.dir;-1==$.inArray(j,S3.gis.dirs)&&S3.gis.dirs.push(j)}else j="";var l=void 0!=a.opacity?a.opacity:1,n=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,a=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold;S3.gis.image=
...
function addTMSLayer(a){var b=a.name,c=[a.url];void 0!=a.url2&&c.push(a.url2);void 0!=a.url3&&c.push(a.url3);var d=a.layername,e=void 0!=a.zoomLevels?a.zoomLevels:9;if(void 0!=a.dir){var f=a.dir;-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)}else f="";b=new OpenLayers.Layer.TMS(b,c,{dir:f,layername:d,type:void 0!=a.format?a.format:"png",numZoomLevels:e});void 0!=a.attribution&&(b.attribution=a.attribution);map.addLayer(b)}
function addWFSLayer(a){var b=a.name,c=a.url,d=a.title,e=a.featureType,f=a.featureNS,g=a.schema,h=void 0!=a.version?a.version:"1.1.0",j=void 0!=a.geometryName?a.geometryName:"the_geom",l=void 0!=a.styleField?a.styleField:"",n=void 0!=a.styleValues?a.styleValues:{},m=void 0!=a.visibility?a.visibility:!0;if(void 0!=a.dir){var p=a.dir;-1==$.inArray(p,S3.gis.dirs)&&S3.gis.dirs.push(p)}else p="";var k=void 0!=a.opacity?a.opacity:1,q=void 0!=a.cluster_distance?a.cluster_distance:S3.gis.cluster_distance,
r=void 0!=a.cluster_threshold?a.cluster_threshold:S3.gis.cluster_threshold,a=new OpenLayers.Protocol.WFS({version:h,srsName:void 0!=a.projection?"EPSG:"+a.projection:"EPSG:4326",url:c,featureType:e,featureNS:f,geometryName:j,schema:g}),c={context:{radius:function(a){var b=12;a.cluster&&(b=Math.min(a.attributes.count/2,8)+12);return b},fill:function(a){var b="#f5902e";a.cluster&&(b="#8087ff");return b},stroke:function(a){var b="#f5902e";a.cluster&&(b="#2b2f76");return b},label:function(a){var b="";
a.cluster&&1<a.attributes.count&&(b=a.attributes.count);return b}}};l&&n&&(c.context.fill=function(a){var b;$.each(n,function(c,d){c==a.attributes[l]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#8087ff");return b},c.context.stroke=function(a){var b;$.each(n,function(c,d){c==a.attributes[l]&&(b=d)});b||(b="#f5902e");a.cluster&&(b="#2b2f76");return b});k=new OpenLayers.Style({label:"${label}",labelAlign:"cm",pointRadius:"${radius}",fillColor:"${fill}",fillOpacity:k/2,strokeColor:"${stroke}",strokeWidth:2,
strokeOpacity:k},c);k=new OpenLayers.StyleMap({"default":k,select:{fillColor:"#ffdc33",strokeColor:"#ff9933"}});projection=!projection||"4326"==projection?S3.gis.proj4326:new OpenLayers.Projection("EPSG:"+projection);b=new OpenLayers.Layer.Vector(b,{maxFeatures:1E3,strategies:[new OpenLayers.Strategy.BBOX({ratio:1.5}),new OpenLayers.Strategy.Cluster({distance:q,threshold:r})],dir:p,projection:projection,protocol:a,styleMap:k});b.title=d;b.setVisibility(m);b.events.on({featureselected:onWfsFeatureSelect,
featureunselected:onFeatureUnselect});map.addLayer(b);S3.gis.layers_all.push(b)}
function addWMSLayer(a){var b=a.name,c=a.url,d=a.layers,e=void 0!=a.visibility?a.visibility:!0;if(void 0!=a.dir){var f=a.dir;-1==$.inArray(f,S3.gis.dirs)&&S3.gis.dirs.push(f)}else f="";var g=void 0!=a.base?a.base:!1,h=void 0!=a.transparent?a.transparent:!0,j=void 0!=a.format?a.format:"image/png",l=void 0!=a.version?a.version:"1.1.1",n=void 0!=a.map?a.map:"",m=void 0!=a.style?a.style:"",p=void 0!=a.bgcolor?"0x"+a.bgcolor:"",k=void 0!=a.buffer?a.buffer:0,q=void 0!=a.tiled?a.tiled:!1,r=void 0!=a.opacity?
a.opacity:1;if(void 0!=a.legendURL)var s=a.legendURL;a=new OpenLayers.Layer.WMS(b,c,{layers:d},{dir:f,wrapDateLine:!0,isBaseLayer:g,queryable:void 0!=a.queryable?a.queryable:1,visibility:e});n&&(a.params.MAP=n);j&&(a.params.FORMAT=j);h&&(a.params.TRANSPARENT=!0);l&&(a.params.VERSION=l);m&&(a.params.STYLES=m);p&&(a.params.BGCOLOR=p);q&&(a.params.TILED=!0,a.params.TILESORIGIN=[map.maxExtent.left,map.maxExtent.bottom]);g||(a.opacity=r,a.buffer=k?k:0);s&&(a.legendURL=s);map.addLayer(a)}
function s3_gis_loadDetails(a,b,c){$.ajax({url:a,success:function(a){$("#"+b).html(a);c.updateSize()},error:function(a,e,f){msg="UNAUTHORIZED"==f?S3.i18n.gis_requires_login:a.responseText;$("#"+b+"_contentDiv").html(msg);c.updateSize()},dataType:"html"})}
...
if(void 0==a.attributes.data)h="";else if(0===a.attributes.data.indexOf("http://"))var d=!0,j=S3.uid(),h='<div id="'+j+'">'+S3.i18n.gis_loading+"...<img src='"+S3.gis.ajax_loader+"' border=0 /></div>";else h="<p>"+a.attributes.data+"</p>";var l=void 0==a.attributes.image?"":0===a.attributes.image.indexOf("http://")?'<img src="'+a.attributes.image+'" height=300 width=300>':"",g=e+f+g+h+l}c=new OpenLayers.Popup.FramedCloud(b,c,new OpenLayers.Size(200,200),g,null,!0,onPopupClose);void 0!=a.attributes.url?
